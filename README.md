		...
		<a href="https://httpsrathanaphon.websites.co.in" title="Rathana phone Shop1" class="td-none text-center">
				...
				<ul class="navbar-nav mt-2 mt-lg-0 flex-md-row text-center text-md-left" style="flex-wrap: wrap;">
							...
							<li class="nav-item ">
								...
								<ul class="dropdown-menu text-center text-md-left" aria-labelledby="navbarDropdownMenuLink">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center my-2">
                        ...
                        <a class="btn btn-outline-light br-2 m-2"
                            data-toggle="modal" 
...
<span class="price-new"> USD </span>
    ...
    <div class="h-15 position-relative mx-auto d-flex justify-content-center align-items-center w-100">
        ...
        <div class="product-card-media-overlay d-flex flex-column shadow-lg">
            ...
            <a title="share Teblet  F29 on twitter" 
                target="_blank" 
                rel="noopener nofollow" 
    ...
    <div class="h-15 position-relative mx-auto d-flex justify-content-center align-items-center w-100">
        ...
        <div class="product-card-media-overlay d-flex flex-column shadow-lg">
            ...
            <a title="share Teblet 8.1in on twitter" 
                target="_blank" 
                rel="noopener nofollow" 
    ...
    <div class="d-block text-center">
                ...
                data-phasvariations= "1" 
                data-pvariationslength= "1" 
                data-pvariationslabel-1=Black will be silver data-pvariationslabel-1-choiceslength = 1 data-pvariationslabelvalue-1-1=Black will be black  
                class="_custom_toast _ecom_addtocart card-action-btn order-btn td-none mx-auto br-2">
                <i class="fas fa-cart-plus"></i>
                Add To Cart
            </a>
...
<div class="fb-page" 
    ...
    <blockquote cite="https://tagassistant.google.com/#/?url=https%3A%2F%2Fhttpsrathanaphon.website.co.in%2F" 
        ...
        <a href="https://tagassistant.google.com/#/?url=https%3A%2F%2Fhttpsrathanaphon.website.co.in%2F">Facebook</a>
                    ...
                    <div class="col-md-4 col-sm-12 my-3">
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Get latest deals, offers & products updates via e-mail</small>
                            <div class="mt-3">
                                <form>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-primary" 
                                                title="subscribe to Rathana phone Shop1"
                                                type="button" 
                                                id="subscribe">
                                                SEND
                                                <i id="subscriber_send" class="show fas fa-paper-plane"></i>
                        ...
                        <div>
                            <h4 class="fs-125 font-weight-light position-relative mb-4 font-play">
                                ...
                                <span class="header-underline"></span>
                                                            ...
                                                            <a title="go to facebook page of Rathana phone Shop1"
                                    href="https://httpsrathanaphon.websites.co.in" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-facebook-f fs-1 share-icon"></i>
                                </a>
                             
                            
                                                            <a title="go to twitter page of Rathana phone Shop1"
                                    href="https://httpsrathanaphon.websites.co.in" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-twitter fs-1 share-icon"></i>
                                </a>
                             
                            
                                                            <a title="go to google plus page of Rathana phone Shop1"
                                    href="https://httpsrathana-phoneshop1-business-development-service.business.site" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-google-plus-g share-icon"></i>
                                                            ...
                                                            <a title="go to linkedin page of Rathana phone Shop1" 
                                    href="https://httpsrathanaphon.websites.co.in" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-linkedin-in share-icon"></i>
                                                            ...
                                                            <a title="go to instagram page of Rathana phone Shop1"
                                    href="https://httpsrathanaphon.websites.co.in" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-instagram share-icon"></i>
                                                            ...
                                                            <a title="go to quora page of Rathana phone Shop1"
                                    href="https://httpsrathanaphon.websites.co.in" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-quora share-icon"></i>
                                </a>
                            
                                                            <a title="go to youtube page of Rathana phone Shop1"
                                    href="http://www.youtube.com/@rathanaphon29" 
                                    target="_blank" 
                                    rel="noopener nofollow">
                                    <i class="fab fa-youtube share-icon"></i>
                                </a>
                            
                                                            <a title="go to website of Rathana phone Shop1"
                                    href="https://httpsrathana-phoneshop1-business-development-service.business.site" 
                                    target="_blank" 
                                    rel="noopener nofollow">
        ...
        <div class="row">
                    ...
                    <div class="footer-useful-tags">
                                            </div>
                </div>
                              

       <div class="col-md col-sm-12 text-right">
...
document.head.appendChild(style);
        ...
        <footer class="copy-right py-2 text-white">
    <div class="container">
        <div class="row">
            <div class="col-md col-sm-12 text-center">
                &copy; 2023
                                    <span>Rathana phone Shop1Business As a loyal partner sale technology</span>
                            </div>

            
                            <div class="col-md col-sm-12 text-center">
                    <i class="fa fa-sitemap"></i>
                    <a title="view Rathana phone Shop1 sitemap" class="text-white" href="https://httpsrathanaphon.websites.co.in/sitemap" target="_blank" rel="noopener">
                        Sitemap
                    </a>
                </div>
            
                            <div class="col-md col-sm-12 text-center">
                    <i class="fa fa-chart-line"></i> 18664 views
                </div>
            
            <div class="col-md col-sm-12 text-center">
                <a href="javascript:void(0);" title="report this website" class="text-white" id="report-btn" rel="noopener">
                    <i class="fas fa-exclamation-circle"></i> Report abuse
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="quick-float">
            ...
            target="_blank" 
            rel="noopener nofollow" 
            href="https://api.whatsapp.com/send?phone=855085883923&text=Hi, Rathana phon need more information about Rathana phone Shop1. please contact me.">
            <img class="quick-float-icon" 
                src="https://httpsrathanaphon.websites.co.in/img/svg-icons/whatsapp.svg" 
                alt="WhatsApp" 
                title="message Rathana phone Shop1 on WhatsApp">
        </a>
        
                                                            <a class="_click_record" 
                        data-websiteid="971938" 
                        data-type="map" 
                        target="_blank" 
                        rel="noopener nofollow" 
                        href="https://www.google.com/maps/?q=19.076,72.8774">
                        <img class="quick-float-icon" 
                            src="https://httpsrathanaphon.websites.co.in/img/svg-icons/google.svg" 
                            alt="Google Map" 
                            title="view Rathana phone Shop1 on google map">
                    </a>
                                        </div>
        <div class="popup">
    <div id="popup" class="popup__content">
        ...
        <div class="hide popup__button__div">
            <a class="popup__button"></a>
        </div>
    </div>
</div>        <!-- alerts -->
        
        <!--Search Modal Structure -->
<div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="search-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="search-modal">Search</h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" 
                                    ...
                                    name="query" 
                                    id="query" 
                                    placeholder="Please Enter Search Term" required>
                            </div>               
                   </div>
                        </div>
                    </div>
                    ...
                    <div class="row ml-4">
                        ...
                        <div class="col-md-4 col-sm-12 custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="updates">
        ...
        <div class="modal fade" id="enquiryModal" tabindex="-1" role="dialog" aria-labelledby="enquiry-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h5 class="modal-title text-center" id="enquiry-modal">Enquiry
                    <button type="button" title="colse inquiry modal" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </h5>
                
                <form class="p-3" role="form" id="sendMessageEnquiryForm">
                    <input type="hidden" name="_token" value="4FkmBWmaprPH9YwzameQlOOgfzY5wuvUvJ9HoaB4">
                
                    <div id="sendMessageEnquiryForm-response" class="alert alert-dismissible fade hide" role="alert">
                        <span id="sendMesssageEnquiryForm-status"></span>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-reset br-none" name="name" id="enquiry_name" placeholder="Name">
                    </div>
                
                    <div class="form-group">
                        
                        <input type="email" class="form-control input-reset br-none" name="email" id="enquiry_email" placeholder="Email">
                    </div>
                
                    <div class="row">
                        <div class="form-group col-md-5 col-sm-12">
                            
                            <select id="enquiry_phonecode" name="phonecode" class="form-control br-none">
                            </select>
                        </div>
                
                        <div class="form-group col-md-7 col-sm-12 pl-md-0">
                            
                            <input type="text" class="form-control input-reset br-none" name="phone" id="enquiry_phone" placeholder="Phone Number">
                        </div>
                    </div>
                
                    <div class="form-group">
                        
                        <textarea class="form-control input-reset br-none" name="message" id="enquiry_message" rows="3" placeholder="Message"></textarea>
                    </div>
                
                    <div class="form-group">
                        <div class="recaptcha">
                            <div id="g-recaptcha-widget3" class="recaptcha-scale"></div>
                        </div>
                    </div>
                
                    <input type="hidden" name="user_id" value="1702375">
                
                    <input type="hidden" name="businessdetails_id" value="972104">
                
                    <input type="hidden" name="website_id" value="971938">
                
                    <div class="form-group text-center">
                        <a id="sendEnquiryMessage" class="btn btn-outline-primary br-2">
                            Submit
                            <i id="Enquiry_send" class="show fas fa-paper-plane"></i>
                            <i id="Enquiry_loader" class="hide fas fa-circle-notch fa-spin"></i>
                        </a>
                    </div>
        ...
        <!-- order Modal -->
        <div class="modal fade" id="orderModal" tabindex="-1" role="dialog" aria-labelledby="order-modal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <h5 class="modal-title text-center" id="order-modal">
                            <span id="title-product-btn-value"></span> <span id="title-product-name"></span>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </h5>
...
<form class="p-3" role="form" id="orderForm">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-reset br-none" name="name" id="order_name" placeholder="Name" required>
    </div>
         <div class="form-group">
        
        <input type="email" class="form-control input-reset br-none" name="email" id="order_email" placeholder="Email" required>
    </div>

    <div class="row">
        <div class="form-group col-md-5 col-sm-12">
            
            <select id="order_phonecode" name="order_phonecode" class="form-control br-none" required>
            </select>
        </div>

        <div class="form-group col-md-7 col-sm-12 pl-md-0">
            
            <input type="text" class="form-control input-reset br-none" name="phone" id="order_phone" placeholder="Phone Number" required>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <textarea class="form-control input-reset br-none" name="address" id="order_address" rows="3" placeholder="Address"></textarea>
        </div>
        <div class="form-group col-md-6">
    ...
    <div class="form-group">
        <div class="recaptcha">
            <div id="g-recaptcha-widget2" class="recaptcha-scale"></div>
        </div>
    </div>

    <input type="hidden" name="product_id" id="product_id" value="">

    <input type="hidden" name="user_id" id="user_id" value="1702375">

    <input type="hidden" name="businessdetails_id" id="businessdetails_id" value="972104">

    <input type="hidden" name="website_id" id="website_id" value="971938">

    <div class="form-group text-center">
        <button type="submit" id="placeOrder" title="place order" class="btn btn-primary br-none text-white">
    ...
    <div class="report-box-header">
        <h4>Safety and Abuse Reporting</h4>
        <div id="report-close-btn" class="report-close-btn">
    ...
    <div class="report-box-body">
        <form class="report-form" role="form" id="report-form">
            ...
            <input type="hidden" id="report-website_id" name="report-website_id" value="971938">
            <input type="hidden" id="report-website_url" name="report-website_url" value="https://httpsrathanaphon.websites.co.in">
        
            <button type="submit" class="report-send-btn">
                Report this website
            </button>
        </form>
        
        <div id="report-success-box" class="report-success-box">
            <h4>Thanks for being awesome!</h4>
            <p>We appreciate you contacting us. Our support will get back in touch with you soon!</p>
            <p>Have a great day!</p>
        </div>

        <div class="confirmation-box" id="confirmation-box">
            <h3 class="c-title">Are you sure you want to report abuse against this website?</h3>
            <div class="c-body">
                <p>Please note that your query will be processed only if we find it relevant. Rest all requests will be ignored. If you need help with the website, please login to your dashboard and connect to support</p>
            </div>
            <div class="c-footer">
                <a href="javascript:void(0);" id="cancel-report-abuse" class="c-btn btn-cancel">Cancel</a>
                <a href="javascript:void(0);" id="confirm-report-abuse" class="c-btn btn-confirm">Confirm</a>
            </div>
        </div>
    </div>
        ...
        <div class="pqv-bg " id="pqv-popup-bg"></div>
<div class="pqv-wrap " id="pqv-popup">    
    <div class="pqv-container">
        <div class="pqv-content">
            <div class="lightbox-content">
                <div class="product-quick-view-container">
                    <button type="button" class="pqv-close pqv-close-btn" id="pqv-popup-close-btn">
                    ...
                    <div class="product-info-col" id="pqv-data">
                        <div class="product-info">
                            <h4 class="product-name" id="pqv-data-pname"></h4>
                            <div class="product-price-row">
                                <p class="p-price">
                                    <span id="pqv-data-pcurrency" class="_pqv_currency"></span>
                                    <span id="pqv-data-pprice" class="_pqv_price"></span>
                                </p>
                            </div>
                              <div class="product-variants-row" id="pqv-choices-area"></div>

                            <div class="product-action-row">
                                <p class="_pqv_error_msg" style="color: red;"></p>
                                <input type="number" min="1" value="1" name="pquantity" id="pqv-pquantity">
                            </div>
        ...
        <!-- slick-->
        <script src="https://httpsrathanaphon.websites.co.in/e-store/slick/slick.min.js"></script>
        ...
        <script src="https://httpsrathanaphon.websites.co.in/common/js/ecom.js?v=2122616558"></script>
        ...
        <script src="https://httpsrathanaphon.websites.co.in/common/js/money.min.js"></script>

        
        <script type="text/javascript">
    if ('serviceWorker' in navigator) {
        try {
            navigator.serviceWorker.register("https://httpsrathanaphon.websites.co.in/service.worker.js?v=1170125913").then(function(
                registration) {
        ...
        <script 
        src="//www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit"
        >
        </script>
    ...
    <div class="fb-customerchat"
        ...
        <!-- Custom Script -->
                                        ...
                                        <script>
                    // Home Page - Our Testmonials Slider
